...
class TiposControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create tipo" do
    assert_difference('Tipo.count') do
      post tipos_url, params: { tipo: { admin_user: @tipo.admin_user, archivo: @tipo.archivo, descripcion: @tipo.descripcion, report_id: @tipo.report_id, user_id: @tipo.user_id } }
    end
  ...
  test "should update tipo" do
    patch tipo_url(@tipo), params: { tipo: { admin_user: @tipo.admin_user, archivo: @tipo.archivo, descripcion: @tipo.descripcion, report_id: @tipo.report_id, user_id: @tipo.user_id } }
