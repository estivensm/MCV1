...
class CargosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create cargo" do
    assert_difference('Cargo.count') do
      post cargos_url, params: { cargo: { description: @cargo.description, name: @cargo.name, proceso_id: @cargo.proceso_id } }
    end
  ...
  test "should update cargo" do
    patch cargo_url(@cargo), params: { cargo: { description: @cargo.description, name: @cargo.name, proceso_id: @cargo.proceso_id } }
