...
def bootstrap_class_for flash_type
  ...
  def menu
    @menum = ["","", "", "" ,"", "","","",""]
  if controller.controller_name == "views" || controller.controller_name == "procesos" || controller.controller_name == "cargos" || (controller.controller_name == "companies" && action_name != "company_indicators") || (controller.controller_name == "employeds" && action_name != "edit_myself" && (action_name == "show" && current_user.rol.configuracion) ) || controller.controller_name == "normas" ||controller.controller_name == "numerals" ||controller.controller_name == "sources" ||controller.controller_name == "rols" ||controller.controller_name == "clinte_proveedors" ||controller.controller_name == "source_parents"
    @menum = ["active2","", "", "", "", "","",""]
